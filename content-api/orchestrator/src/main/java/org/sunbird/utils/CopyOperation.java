...
public class CopyOperation {
    ...
    public static Node copy(Node existingNode, Map<String, Object> requestMap, String mode) {
        return equalsIgnoreCase((String) existingNode.getMetadata().get("mimeType"), "application/vnd.ekstep.content-collection") ?
                copyCollectionContent(existingNode, requestMap, mode) :
                copyContentData(existingNode, requestMap, mode);
    }
    ...
    private static Node copyContentData(Node existingNode, Map<String, Object> requestMap, String mode) {
    ...
    private static Node copyCollectionContent(Node existingNode, Map<String, Object> requestMap, String mode) {
       Node copyNode = copyContentData(existingNode,requestMap,mode);
       return copyNode;
    }
...
//                }
    ...
    public static void prepareHierarchy(Response response) {
